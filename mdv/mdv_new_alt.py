# this I found of server of mine, seems to contain some fixes for src and img
# tags, need to merge. Checked in to not loose it. Time....

1.root@m01:/opt/m2/app/markdown_mdv# cat mdv.py
#!/usr/bin/env python
# coding: utf-8
...
def read_themes():
    from ast import literal_eval as loads
    if not themes:
...
def main(md=None, filename=None, cols=None, theme=None, c_theme=None, bg=None,
    ...
    if not c_theme:
        c_theme = os.environ.get('AXC_THEME_CODE') or theme or 'default'
...
1.root@m01:/opt/m2/app/markdown_mdv# 
